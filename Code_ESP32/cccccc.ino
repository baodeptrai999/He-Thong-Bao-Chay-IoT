...
#define SIM_RX 19
#define SIM_TX 18
#define PHONE_NUMBER "0936412422"
...
//------------------------------------------------------------------------------
// ================= HÀM SIM =================
void sendCommand(String cmd, unsigned long timeout = 2000) {
  SIM.println(cmd);
  Serial.println("> " + cmd);
    ...
    while(1) {
         if(autoManual == AUTO) {
          ...
          if(readMQ2() > mq2Thresshold && readFireSensor() == SENSOR_FIRE_ON) {
            ...
            buzzerON = 1;
            sendSMS(PHONE_NUMBER, "CANH BAO: PHAT HIEN KHI GAS VA LUA!");
            delay(500);
            My_LCD.clear();
            ...
            LCDPrint(1,2, "GAS DETECTED",0 );
            buzzerON = 1;
            sendSMS(PHONE_NUMBER, "CANH BAO: PHAT HIEN KHI GAS!");
          }
            ...
            LCDPrint(1,2, "FIRE DETECTED",0 );
            buzzerON = 1;
            sendSMS(PHONE_NUMBER, "CANH BAO: PHAT HIEN LUA");
